...
;(() => {
  ...
  const PORTRAIT_FRAC    = 1.00;  // make smaller if it touches UI; larger if you want it bigger
  const LANDSCAPE_FRAC   = 1.50;  // use >1.0 to use more of the short edge on landscape
